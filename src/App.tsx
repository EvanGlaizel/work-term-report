...
function App() 
{
  ...
  [
    ...
    {text: "I would like to acknowledge my direct supervisor and Program Manager, Brandon Cusato for supporting me while I was an instructor. He always went out of his way to ensure I had everything I needed to succeed, assisted us in any way that he could, and always had a positive attitude, even when we were behind schedule on projects."},
